...
export class ButtonDirective {
  ...
  private setButtonClasses() {
    ...
    let baseClasses = 'inline-flex items-center border justify-center font-medium focus:outline-none focus:ring-4 focus:ring-offset-2 transition-colors duration-300 ';
