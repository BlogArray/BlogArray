...
public static class UserErrors
{
    ...
    {
        return ErrorDetails.NotFound("User.NotFound", $"The user with Id '{id}' was not found.");
    }
    ...
    /// <returns>An <see cref="IActionResult"/> representing the user not found error.</returns>
    public static IActionResult EmailNotFound(string email)
    {
        return ErrorDetails.NotFound("User.EmailNotFound", $"The user with email '{email}' was not found.");
    }
    ...
    public static IActionResult EmailExists(string email)
    {
        return ErrorDetails.Conflict("User.EmailExists", $"The user with email '{email}' already exists.");
    }
    ...
    public static IActionResult UsernameExists(string username)
    {
        return ErrorDetails.Conflict("User.UsernameExists", $"The user with username '{username}' already exists.");
    }
    ...
    public static IActionResult Invalid()
    {
        return ErrorDetails.Unauthorized("User.Invalid", "Invalid username or password.");
    }
    ...
    /// </summary>
    /// <returns>An <see cref="IActionResult"/> representing the unauthorized error.</returns>
    public static IActionResult UserLocked()
    {
        return ErrorDetails.Unauthorized("User.Lockedout", "User account is locked for additional security.");
    }
    ...
    {
        return ErrorDetails.Unauthorized("User.Unauthorized", "You are not authorized to perform this action.");
    }
    ...
    {
        return ErrorDetails.Forbidden("User.Forbidden", "You do not have permission to access this resource.");
    }
    ...
    {
        return ErrorDetails.InternalServerError("User.InternalServerError", "An unexpected error occurred. Please try again later.");
    }
    ...
    public static IActionResult BadRequest(string description)
    {
        return ErrorDetails.BadRequest("User.BadRequest", description);
    }
}
